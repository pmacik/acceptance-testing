# This file is depricated use ClusterProvider.py instead
...
#              print('Using existing kind cluster for ' +
...
#              print('Creating new kind cluster for ' +
...
#              print('Num pods ready: '+str(num_ready) +
